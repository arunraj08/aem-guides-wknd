...
@Component(service = WorkflowProcess.class, property = { "process.label= Set Asset Review Status" })
@ServiceDescription(value = "Workflow process to set Asset Review Status")
