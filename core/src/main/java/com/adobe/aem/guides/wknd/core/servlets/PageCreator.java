 ...
 *
 * SAMPLE
 * curl -u admin:admin -X POST http://localhost:4502/content/pagecreator.json -F importer="/content/wknd/us/en/test/community,Our Community,/conf/wknd/settings/wcm/templates/content-page-template,/content/cq:tags/wknd-shared/community"
 */
...
@ServiceDescription("Training Page Creator Servlet")
